...
const Login = ()=>{
    ...
    const login = async (e) =>{
        ...
        try{
          const res = await axios.post('https://colleeasy.herokuapp.com/login', newEntry, {withCredentials: true});
        ...
        // const s = await axios.post('https://colleeasy.herokuapp.com/login', newEntry).then(navigate('/announce')).catch(err=>console.log("Error"))
