...
const InfluencerCompleteOrderList = ()=>{
    ...
    useEffect(()=>{
        axios.get("https://colleeasy.herokuapp.com/influencercompletedorders").then(
            (res)=>{
    ...
    //     await axios.post("https://colleeasy.herokuapp.com/RatingAcceptedInfluencer",acceptData)
    //     console.log(myID)
    // }
    const sendRating2 = async(myrating, clientEmail , myID)=>{
        ...
        //     console.log(acceptData);
        //     await axios.post("https://colleeasy.herokuapp.com/RatingsSendClient" , acceptData);
        // }
        const ratingOrder = {email:clientEmail , myrating :myrating , myID:myID}
        console.log(ratingOrder)
        let request1 =  axios.post("https://colleeasy.herokuapp.com/RatingAcceptedInfluencer",ratingOrder)
        const acceptData = {email:clientEmail , myrating :myrating , myID:myID}
        console.log("rating set done")
        console.log(acceptData)
        let request2 =  axios.post("https://colleeasy.herokuapp.com/RatingsSendClient" , acceptData);
        // axios.all([request2])
