...
const ClientCompleteOrderList = ()=>{
    ...
    useEffect(()=>{
        axios.get("https://colleeasy.herokuapp.com/clientCompletedorders").then(
            (res)=>{
    ...
    const sendRating = async(myrating, influencerEmail , myID)=>{
        ...
        let request1  =  axios.post("https://colleeasy.herokuapp.com/RatingAccepted", ratingOrder)
        ...
        let newrate = await axios.get('https://colleeasy.herokuapp.com/GetRatingClient' ,{withCredentials:true} ,ratedata)
        .then(response => {
            ...
            let Ordercount  = axios.get('https://colleeasy.herokuapp.com/getOrder' , ratedata)
            .then(response => {
                ...
                //third query
                let request2 =  axios.post("https://colleeasy.herokuapp.com/RatingsSendInfluencer" , acceptData);
            })
        }).catch(error => {
            console.log(error);
        });
